...
export default function Button({ text, variant = "bluePrimary" }) {
  const baseStyles =
    "relative flex items-center justify-center overflow-hidden rounded-full text-lg xl:text-base font-medium py-4 px-6 md:py-2 mt-8 transition duration-500 w-full md:w-auto";
