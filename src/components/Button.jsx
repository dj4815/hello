export default function Button({ text, variant = "bluePrimary" }) {
  ...
  const styles = {
    bluePrimary: `${baseStyles} bg-blue-700 hover:bg-blue-500 text-white transition-colors duration-300 shadow-md`,
    ...
    blackPrimary: `${baseStyles} bg-black border-2 border-black text-white hover:bg-white hover:text-black`,
  };
