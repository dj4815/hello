      ...
      <div className="min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <p className="text-lg">
            ...
            experience in HTML, CSS, JavaScript, and React, I enjoy turning
            ideas into code and solving real-world problems through intuitive
            design and development. Whether it's a portfolio, an app, or a
            custom project, I aim to write clean code and create smooth user
            experiences.
          </p>
        </Section>
      </div>
